jQuery(function($){
	...
	var _pb_calendar = (function(target_, options_){
		...
		this._target.append('<div class="calendar-head-frame blau">' +
			'<div class="row row-dayname">' +
				'<div class="col col-dayname holiday">SO</div>' +
				'<div class="col col-dayname">MO</div>' +
				'<div class="col col-dayname">DI</div>' +
				'<div class="col col-dayname">MI</div>' +
				'<div class="col col-dayname">DO</div>' +
				'<div class="col col-dayname">FR</div>' +
				'<div class="col col-dayname">SA</div>' +
			'</div>' +
		'</div>');
